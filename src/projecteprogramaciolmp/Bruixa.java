...
////// ================================================================================================================= //////
    ...
    // amb un altre seleccionat
        ...
        int monedesJugExe= p.getMonedesJugador(p.getIndexJugadorExecutador(0));                                          // Guardem en una variable local les monedes que te el jugador executador
        int monedesJugVictima= p.getMonedesJugador(aux.get(0));                                                         // Guardem en una variable local les monedes que te el jugador victima
       
        //TRACTAMENT DADES
        p.afegirMonedesJugador(p.getIndexJugadorExecutador(0), -p.getMonedesJugador(p.getIndexJugadorExecutador(0)));     // Setejo les monedes del jugador executador a 0
        p.afegirMonedesJugador(aux.get(0), -p.getMonedesJugador(aux.get(0)));                                           // Setejo les monedes del jugador victima a 0
        
        p.afegirMonedesJugador(p.getIndexJugadorExecutador(0), monedesJugVictima);                                       // Sumo les monedes del jugador victima al jugador executador
